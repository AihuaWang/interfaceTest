...
class TestCase(object):
    ...
    def __init__(self, fn):
        ...
        if arg_count > 0:
            raise Exception(u"测试用例函数不能有参数，{0} 含有 {1} 个参数".format(case_path, arg_count))
    ...
    def __call__(self):
        ...
        try:
            ...
            print colored(u"======> √ Test Ok , case_path: [ {0} ]".format(case_path), "blue")
            return result
        except AssertionError as e:
            # traceback.print_exc()
            print e.message
            print colored(u"======> × Test Fail, case_path: {0}, Info: [ {1} ]".format(case_path, e.message), "red")
